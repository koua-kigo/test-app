...
export function RestaurantSearchBar({
  ...
  return (
    <div
      className={`flex flex-col lg:flex-row  justify-center items-center content-center w-[80%] mx-auto`}
      style={{margin: '12px auto'}}
    >
      <div
        className={`w-full md:w-[60%]  ${className} rounded-lg p-4 flex justify-evenly w-content rounded-full `}
        style={
          {
            // background:
      ...
      >
        <div className='relative w-auto flex-grow align-middle items-center flex rounded-full'>
          <Search
          ...
          <Input
            ...
            style={{border: '2px solid #268552'}}
          />
        </div>
      </div>
      <div className='flex items-center gap-4 justify-center  w-content px-4 '>
        <div
